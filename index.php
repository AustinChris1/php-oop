                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="modal-body">
                            ...
                            <img class="img-fluid d-block mx-auto mb-5" src="assets/img/portfolio/6.jpg" alt="..." />
                                ...
                                <div class="row align-items-stretch mb-5">
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" name="loginEmail" id="email" type="email"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" name="loginPassword" id="password" type="password"
                                                placeholder="Your Password *" data-sb-validations="required,password" />
                                            <div class="invalid-feedback" data-sb-feedback="password:required">An password is
                                                required.</div>
                                            <div class="invalid-feedback" data-sb-feedback="password:password">Email is not
                                                valid.</div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="modal-body">
                            ...
                            <img class="img-fluid d-block mx-auto mb-5" src="assets/img/portfolio/3.jpg" alt="..." />
                                ...
                                <div class="row align-items-stretch mb-5">
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" id="name" name="regName" type="text" placeholder="Your Name *"
                                                required />
                                        </div>
                                        <div class="form-group mb-3">
                                            <!-- Email address input-->
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" id="username" name="regUsername" type="text"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" id="password" name="confirmPassword" type="password"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" id="phone" name="regPhone" type="tel" placeholder="Your Phone *"
                                                required />
                                    </div>
                                </div>
                                <!-- Submit Button-->
